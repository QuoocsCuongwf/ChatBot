"""
run_pipeline_v4.py — V4: Fine-tuned Bi-Encoder + ms-marco CE Rerank

Pipeline:
    legal_hf_finetuned (fine-tuned trên data dự án) → FAISS top-50
        → cross_encoder_v1 (ms-marco-MiniLM fine-tuned) Rerank

Tương ứng: baseline_v4_finetune_bi.ipynb

Usage:
    ./venv/python.exe run_pipeline_v4.py
"""
...
def main():
    ...
    print(f"  CE         : {CE_MODEL_PATH}  (ms-marco, cross_encoder_v1)")
    ...
    print(f"\nLoading CE (ms-marco v1): {CE_MODEL_PATH}")
